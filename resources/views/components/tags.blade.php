                ...
                <div class="flex p-1 my-2 bg-white border border-gray-200 rounded">
                    <div class="flex flex-wrap flex-auto">
                        ...
                        <template x-for="(option,index) in selected" :key="options[option].value">
                            ...
                            <div
                                class="flex items-center justify-center px-1 py-1 m-1 font-medium bg-white border rounded">
                ...
                <div x-show.transition.origin.top="isOpen()"
                    ...
                    <div class="flex flex-col w-full overflow-y-auto">
                        <template x-for="(option,index) in options" :key="option" class="overflow-auto">
                            <div class="w-full border-b border-gray-200 rounded-t cursor-pointer hover:bg-gray-100"
