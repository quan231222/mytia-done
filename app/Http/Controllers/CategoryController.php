...
class CategoryController extends Controller
{
    ...
    public function store(StoreCategoryRequest $request)
    {
        ...
        return redirect()->route('categories.index')->with('success', 'Danh mục đã xuất hiện trên cuộc sống này!');
    }
    ...
    public function destroy(Category $category)
    {
        ...
        return redirect()->route('categories.index')->with('success', 'Danh mục đã bay màu!');
    }
}
